...
class ModernCppProject(ConanFile):
    ...
    version = "1.0.0"
    description = "C++ Face Recognition Project"
    topics = ("conan", "cpp", "face recognition")
    url = "https://github.com/reshalfahsi/simple-face-recognition-project"
    homepage = "https://reshalfahsi.github.io"
    license = "MIT"
